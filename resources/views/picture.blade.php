            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Date Taken: 2024-09-01</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Date Taken: 2024-09-02</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Date Taken: 2024-09-03</p>
                    </div>
                </div>
            </div>
        </div>
...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="https://plus.unsplash.com/premium_photo-1667126444822-94fb21279436?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YXV0dW1ufGVufDB8fDB8fHww"
                        class="card-img-top" alt="Picture 1">
                    <div class="card-body">
                        <h5 class="card-title">Picture 1</h5>
                        <p class="card-text">Date Taken: 2024-09-01</p>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="https://www.zdnet.com/a/img/resize/4031321146ad6df3889674fe60f557d95966fc0e/2019/09/05/7c148e17-3f7e-4166-b755-324799ba0c7a/atanas-malamov-tpmav6c33de-unsplash.jpg?auto=webp&width=1280"
                        class="card-img-top" alt="Picture 3">
                    <div class="card-body">
                        <h5 class="card-title">Picture 3</h5>
                        <p class="card-text">Date Taken: 2024-09-03</p>
                    </div>
